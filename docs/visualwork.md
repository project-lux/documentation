...
| LUX Field Name | LUX Description | LUX Path |
| -------------- | --------------- | -------- |
| Creator in Production Event | Creator of Visual Work. Often, but not always, the same as the producer of the Human Made Object. May be nested in `part`. | created_by > carried_out_by |
...
| LUX Field Name | LUX Description | LUX Path |
| -------------- | --------------- | -------- |
| Statement Type | Classification about the statement on the Visual Work. | referred_to_by > classified_as |
...
| LUX Field Name | LUX Description | LUX Path |
| -------------- | --------------- | -------- |
| Statement Language | Language of statement on the Visual Work.| referred_to_by > language |
...
| LUX Field Name | LUX Description | LUX Path |
| -------------- | --------------- | -------- |
| Part of Object | This does not currently exist in LUX data, but may in the future. Potential use case: A record for a Visual Work that is a part of a larger Visual Work. | part_of |
